...
def images_index():
    ...
    Complete the code below generating a valid response.
     ...
     -X GET -H 'Accept: application/json' http://localhost:8080/containers/images
...
def containers_show(id):
    ...
    curl -s -X GET -H 'Accept: application/json' http://localhost:8080/containers/containers/<id>
...
def containers_log(id):
    ...
    Dump specific container logs
     ...
     curl -s -X GET -H 'Accept: application/json' http://localhost:8080/containers/containers/<id>/logs
    """
...
def images_remove(id):
    ...
    curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/containers/images/<id>
    """
    docker ('rmi', id)
    resp = '{"id": "%s"}' % id
    return Response(response=resp, mimetype="application/json")
...
def containers_remove(id):
    ...
    Delete a specific container - must be already stopped/killed
     ...
     curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/containers/containers/<id>
    """
    docker('rm', id)
    resp = '{"id": "%s"}' % id
    return Response(responsei=resp, mimetype="application/json")
...
def containers_remove_all():
    ...
    Force remove all containers - dangrous!
     ...
     curl -s -X DELETE -H 'Accept: application/json' http://localhost:8080/containers/containers
    """
    imageArray = docker_images_to_array(docker('images'))
    for i in containerArray:
	docker('rmi', i['id'])
    resp = '{"%d containers removed"}' %len(containerArray)
    return Response(response=resp, mimetype="application/json")
...
def images_update(id):
    ...
    docker('tag', id)
    resp = "%s added as tag to %s" %tag %id 
